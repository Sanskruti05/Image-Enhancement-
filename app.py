...
st.sidebar.title("Enhancement Options for the input")
enhancement_type = st.sidebar.selectbox("Select Enhancement Type for the image", ["Bilateral Filtering", "Unsharp Masking", "Saturation Enhancement", "Gamma Correction", "Edge Enhancement (Laplacian)"])

# Upload an image
input_images = st.file_uploader("Upload an image", type=["jpg", "jpeg", "png"])
...
if input_images is not None:
    ...
    st.write("To download the enhanced image click the link below.")
